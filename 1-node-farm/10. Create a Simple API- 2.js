...
const server = http.createServer((req, res) => {
    ...
    if(pathName === "/" || pathName === "/overview") {
        ...
        fs.readFile(`${__dirname}/dev-data/data.json`, 'utf-8', (err, data) => {//Using 'dirname' variable for current directory. Using ES6 template string syntax.
            ...
            res.writeHead(200, {//code 200 means 'OKAY'
