...
const server = http.createServer((req, res) => {
    ...
    if(pathName === "/" || pathName === "/overview") {
        ...
        res.writeHead(404, {//sending error status code in the console of the page. This method can also send 'Headers' in the second argument within an object. An HTTP header is a piece of information about the respose we're sending back.
