...
//We have logger middleware(morgan) here and we want to only run that middleware so to only define it when we are actually in development, so that the login does not happen when the app is in production.
