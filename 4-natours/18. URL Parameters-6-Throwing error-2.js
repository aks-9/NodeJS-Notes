...
app.get("/api/v1/tours/:id", (req, res) => {
  ...
  //Another solution that we could of course implement here as well would be to just do this test after we do the tour here. So we would get the ID, then we would try to find a tour, and if there was no tour, well then we would say that the ID is invalid.
