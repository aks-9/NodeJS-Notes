...
app.use(express.json()); //The 'use' method is the one that we use in order to use 'middleware', ie. add 'middleware' to our 'middleware stack'. This 'express.json()' basically returns a function. And so that function is then added to the 'middleware stack'. And so, similar to that, we can create our own middleware function.
