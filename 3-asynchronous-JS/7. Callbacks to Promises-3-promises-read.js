...
const readFileProm = (file) => {
  return new Promise((resolve, reject) => {
    ...
    //we're simply creating a new function which behind the scenes of course still runs the built in 'readFile' function but then returns a 'promise' so that we can use the 'promise' instead of the callback function.
