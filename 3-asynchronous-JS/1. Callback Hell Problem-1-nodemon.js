...
//we're going to use 'dog.text' file in the root directory of the project. And from there we will read the dog breed. And then we are gonna do an HTTP request to get a random image of a dog of a given breed using the DOG API. And then save that random image to another text file. So it's a three step process and all of this will involve call back functions.
