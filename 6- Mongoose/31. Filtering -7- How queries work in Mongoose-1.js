...
exports.getAllTours = async (req, res) => {
  ...
  ==> Now comes the important part. As soon as we actually 'await' the result of the query, so as soon as we use 'await' here: 
    ...
    Instead, what we will have to do, is to save this part here into a query 'await Tour.find(queryObj);'

    then in the end, as soon as we change all the methods to the query that we need to, only then by the end, we can await that query.
