...
//connecting to the DB and passing a object as a second parameter, which will have some optoins to deal with deprecation warnings.This 'connect' method is going to return a promise, so we'll use 'then' method on it.
mongoose
  .connect(DB, {
