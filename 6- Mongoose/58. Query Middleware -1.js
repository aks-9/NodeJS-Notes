...
tourSchema.pre("find", function (next) {
  ...
  //keep in mind that 'this' here is now a query object, all right? And so we can chain all of the methods that we have for queries. And so that simply adds a 'find' method here, and then basically select all the documents where secretTour is not true using '$ne' operator which stands for 'not equal to'. And I'm doing it like this because, remember, the other tours are not currently set to false. They do simply not have this attribute.
