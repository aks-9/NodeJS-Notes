    ...
    priceDiscount: {
      ...
      validate: {
        validator: function (val) {
          //callback function actually has access to the value that was input. So in this case, the price discount that the user specified. So that's what we call the value, 'val' for short.
