...
document middleware can also run for stuff like remove, or for validate. But we didn't talk about these because usually the one that we always use is just for 'save'. Now, query middleware can run for all of these query functions.
