...
//Let's say we want page=2 and there will be a limit field. And this limit here basically means the amount of results that we want per page. And that's actually setted here only to 10.
