...
exports.getAllTours = async (req, res) => {
  try {
    ...
    The query object looks almost identical to the filter object that we wrote manually, the only difference is that in this one we have the MongoDB operator sign here. And so the solution for this is to basically replace all the operators like this with their correspondent MongoDB operators, so basically adding this '$' sign.
